...
def test_add_select_update_delete_project(testrail_session, aunthatification):
...
def test_add_project_positive_case(testrail_session, aunthatification, name, announacement, show_announcement, suite_mode):
    with allure.step('Add project'):
    ...
    with allure.step('Add project'):
        testrail_session.post(url=f"/delete_project/{response.json()['id']}",
                              headers={'Authorization': 'Basic ' + aunthatification,
...
# def test_delete(testrail_session, aunthatification):
#     response_select = testrail_session.get(url=f'/get_projects',
#                            headers={'Authorization': 'Basic ' + aunthatification})
#     print(response_select.json()['projects'][0])
#     for i in response_select.json()['projects']:
#         response_delete = testrail_session.post(url=f"/delete_project/{i['id']}",
#                           headers={'Authorization': 'Basic ' + aunthatification, 'Content-Type': 'application/json'})